...
function main() {
  ...
  test_ServiceNowAdapter.getRecord( (data, error) => {
    console.log(`\nResponse returned from GET new request:${JSON.stringify(data)}`);
    });
  test_ServiceNowAdapter.postRecord( (data, error) => {
    console.log(`\nResponse returned from POST new request:${JSON.stringify(data)}`);
    });
  // console.log(`\nResponse returned from POST request:\n${JSON.stringify(data)}`);
 // console.log(`\nFrom main() function ${test_ServiceNowAdapter.postRecord(JSON.stringify(data))}`);
